-- Add diverse comments from "different users" to make conversations look natural
-- Using the existing user_id for all, but varying the comment content to simulate different people

-- Clear existing comments first
DELETE FROM community_post_comments;

-- Add comments to the under-eye brightening post from different "personalities"

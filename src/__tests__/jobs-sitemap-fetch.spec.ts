...
// These tests hit the live site to ensure the sitemap endpoint is fetchable
const URL = 'https://www.emvi.app/jobs-sitemap.xml';

describe('Jobs sitemap endpoint (live)', () => {

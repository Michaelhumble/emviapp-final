...
const PostJob = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      const compensationType = data.jobType === "Booth Rent" ? "Booth Rental" : 
                              data.jobType === "Commission" ? "Commission" : "Salary";
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          requirements: `Preferred start date: ${data.startDate || "Flexible"}\nPreferred languages: ${data.languages || "Any"}`,
          compensation_type: compensationType,
          compensation_details: data.compensation
        });

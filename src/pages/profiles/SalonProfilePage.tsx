...
import PremiumSalonProfile from "@/components/profile/salon/PremiumSalonProfile";
...
const SalonProfilePage = () => {
  ...
  if (!['salon', 'owner'].includes(userRole || '')) {
  ...
  return (
    <Layout>
      ...
      >
        <PremiumSalonProfile userProfile={userProfile} />
      </motion.div>
    </Layout>
  );
};

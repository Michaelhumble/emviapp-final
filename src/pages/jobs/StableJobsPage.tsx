...
/**
 * A stable and lightweight version of the jobs page
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="border rounded-lg p-6 shadow-sm">
            <h2 className="font-bold text-lg">Jobs Loading...</h2>
            <p className="text-gray-600 mt-2">Please wait while we load job data.</p>
          </div>
        </div>
      </div>
    </Layout>

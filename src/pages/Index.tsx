...
const Index = () => {
  ...
  return (
    <Layout>
      ...
      {/* 1.2 Enhanced Social Media Proof */}
      <section className="py-16 bg-gradient-to-br from-purple-50/50 to-pink-50/30 relative overflow-hidden">
        <div className="container mx-auto px-4 text-center">
          {/* Floating background elements */}
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div className="absolute top-10 left-20 w-32 h-32 bg-purple-400/10 rounded-full blur-2xl animate-float" />
            <div className="absolute bottom-10 right-20 w-40 h-40 bg-pink-400/10 rounded-full blur-2xl animate-float" style={{ animationDelay: '1s' }} />
          </div>
          ...
          >
            <h3 className="text-2xl md:text-3xl font-playfair font-bold text-gray-900 mb-8">
              50,000+ Professionals Trust EmviApp Daily
            </h3>
            <p className="text-lg text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed">
              Follow real success stories and industry insights from our thriving community on social media
            </p>
            
            {/* Enhanced Social Media Badges with Colors */}
            <div className="flex justify-center items-center gap-6 md:gap-8 flex-wrap">
              {[
                ...
                { 
                  ...
                  bgColor: "bg-black/90 hover:bg-black",
                  followers: "8K"
                },
                { 
                  name: "Instagram", 
                  ...
                  bgColor: "bg-gradient-to-r from-purple-500/90 to-pink-500/90 hover:from-purple-500 hover:to-pink-500",
                  followers: "25K"
                },
                { 
                  name: "LinkedIn", 
                  icon: "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z",
                  bgColor: "bg-blue-600/90 hover:bg-blue-600",
                  followers: "15K"
                }
              ].map((social, index) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`${social.bgColor} text-white rounded-2xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 min-w-[120px] min-h-[44px] flex flex-col items-center justify-center group relative overflow-hidden`}
                  aria-label={`Follow us on ${social.name}`}
                >
                  <div className="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <svg className="w-8 h-8 mb-2 relative z-10" fill="currentColor" viewBox="0 0 24 24">
                    <path d={social.icon} />
                  </svg>
                  <span className="text-sm font-semibold relative z-10">{social.name}</span>
                  <span className="text-xs opacity-90 relative z-10">{social.followers} followers</span>
                </motion.a>
              ))}
            </div>
          </motion.div>

      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Have Questions About EmviApp? We've Got Answers!
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Everything you need to know—whether you're a salon owner, artist, investor, or beauty enthusiast. 
            Transparency, trust, and community come first!
          </p>
        </div>
        ...
        {/* Call to Action */}
        <div className="text-center mt-12 p-8 bg-gradient-to-r from-purple-100 to-pink-100 rounded-lg">

...
const testimonials = [
  {
    quote: "EmviApp completely changed how I find clients. My schedule is now fully booked weeks in advance!",
  ...
  {
    quote: "The flexibility EmviApp provides has allowed me to balance my work life and family commitments.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600">
            Hear from professionals and salon owners who have transformed their businesses with EmviApp.
          </p>
        </div>

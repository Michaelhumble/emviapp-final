...
const barberShopImages = [
  "/lovable-uploads/e46083ac-d79b-46b0-97f4-8fbec83362e2.png", // First newly uploaded image
  "/lovable-uploads/baef37ea-b714-4178-8075-a9c8d181055a.png", // Second newly uploaded image
          ...
          {barberShopImages.map((imageSrc, index) => (
            <Card key={index} className="overflow-hidden hover:shadow-md transition-all duration-300">
              ...
              <CardContent className="p-4">
                <h3 className="font-semibold text-lg truncate">Premium Barber Studio {index + 1}</h3>
                <div className="flex items-center text-gray-500 my-1.5 text-sm">
                  <span className="opacity-75">Professional Barber Space</span>
                </div>
              </CardContent>
            </Card>
          ))}

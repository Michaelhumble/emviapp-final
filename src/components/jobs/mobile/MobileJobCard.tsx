    ...
    >
      ...
      {jobImages && jobImages.length > 0 && (
        <div className="relative">
          {jobImages.length === 1 ? (
            ...
            <div>
              ...
              <div className="relative aspect-[16/9] overflow-hidden">
                ...
                />
                {/* Photo count badge - positioned top-left to avoid overlap */}
              ...
              <div className="px-4 py-2 bg-gray-50 flex gap-3">
                {jobImages.slice(1, 4).map((imageUrl, index) => (
                  <div 
                    key={index}
                    className="relative w-12 h-12 rounded border overflow-hidden bg-white shadow-sm cursor-pointer hover:shadow-md transition-shadow"
                  >
                    <img
                      src={imageUrl}
                      alt={`Preview ${index + 2}`}
          ...
          {/* Premium Pricing tier badge - positioned top-right */}
          {!isExpired && (
          ...
          {isExpired ? (
            ...
            <div className="flex flex-wrap gap-2">
              <Button 
                ...
                size="default"
                className="btn-luxury flex-1 min-w-[120px] bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white text-sm font-inter font-black py-3"
              >
              ...
              {isOwner && onEditJob && (
                <Button
                  ...
                  size="default"
                  onClick={onEditJob}
                  className="min-w-[48px] min-h-[48px] border-2 border-purple-600 text-purple-600 hover:bg-purple-50 font-inter font-bold"
                  title="Edit Job"
                >

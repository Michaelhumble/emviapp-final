...
import { Trophy, Crown, Star, TrendingUp, Medal, Zap } from 'lucide-react';
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                />
                <div className={`absolute -top-1 -right-1 w-6 h-6 rounded-full bg-gradient-to-r ${getLevelColors(sharer.level)} flex items-center justify-center`}>
                  {getLevelIcon(sharer.level, index)}
                </div>
              </div>
              ...
              <div>
                <div className="flex items-center space-x-2">
                  <p className="font-semibold text-foreground">{sharer.name}</p>
                  {sharer.badge && (
                ...
                <p className="text-sm text-muted-foreground">{sharer.level} Level</p>
              </div>
            </div>
            ...
            <div className="text-right">
              <div className="flex items-center space-x-1">
                ...
                <span className="font-bold text-lg">{sharer.shares}</span>
              </div>

...
const ArtistProfile = ({ artistProfile, profileCompletion }: ArtistProfileProps) => {
  ...
  // If artistProfile is null, show a placeholder with minimal UI
  if (!artistProfile) {
    return (
        ...
        <CardContent className="relative p-6">
          <div className="flex flex-col md:flex-row gap-6">
            <div className="flex-shrink-0 -mt-16">
              <Avatar className="h-24 w-24 border-4 border-white shadow-md bg-gray-200 animate-pulse">
            ...
            <div className="flex-grow">
              <div className="h-6 bg-gray-200 animate-pulse w-1/3 rounded mb-2"></div>
              <div className="h-4 bg-gray-200 animate-pulse w-1/4 rounded mb-4"></div>

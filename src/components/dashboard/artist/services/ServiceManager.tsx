...
const ServiceManager = () => {
  ...
  const handleAddService = (e: React.FormEvent) => {
    ...
    if (newService.duration_minutes < 5) {
  ...
  const handleEditService = (e: React.FormEvent) => {
    ...
    if (serviceToEdit) {
      ...
      if (serviceToEdit.duration_minutes < 5) {
        toast.error("Duration must be at least 5 minutes");
        return;
      }
  ...
  return (
    <Card className="mb-6">
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          <CardTitle className="text-xl font-serif">Your Services</CardTitle>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {services.map(service => (
              <Card key={service.id} className={`overflow-hidden ${!service.is_visible ? 'bg-gray-50/50 opacity-75' : ''}`}>
                <CardContent className="p-4">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="flex items-center space-x-2">
                <Switch 
                  ...
                  onCheckedChange={(checked) => setNewService({...newService, is_visible: checked})}
                />
            ...
            <form onSubmit={handleEditService}>
              <div className="grid gap-4 py-4">
                ...
                <div className="flex items-center space-x-2">
                  <Switch 
                    id="edit-is_visible" 
                    checked={serviceToEdit.is_visible}
                    onCheckedChange={(checked) => setServiceToEdit({...serviceToEdit, is_visible: checked})}
                  />
                  <Label htmlFor="edit-is_visible">Visible to clients</Label>
                </div>
              </div>

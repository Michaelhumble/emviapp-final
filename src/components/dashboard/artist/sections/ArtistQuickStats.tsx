...
const cardBase =
  "flex-1 min-w-[180px] bg-gradient-to-br from-[#F1F0FB]/80 via-[#E5DEFF]/70 to-white " +
  "rounded-2xl border-0 shadow-[0_4px_20px_0_rgba(155,135,245,0.05)] px-4 py-5 " +
  "flex flex-col items-center gap-2 transition-all hover:scale-[1.03] hover:shadow-md duration-200 ease-in-out";

const labelStyle =
  "text-xs md:text-sm font-medium text-gray-500 mt-1 tracking-wide";

const valueStyle =
  "font-playfair text-3xl md:text-4xl font-bold text-emvi-dark mb-0.5";

const sublabelStyle =
  "text-xs text-emvi-accent mt-1 opacity-80";

const ArtistQuickStats: React.FC = () => (
  <div className="w-full mb-6">
    <div
      className="flex flex-col xs:flex-row xs:items-stretch gap-4 w-full

...
const SalonDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 border-8 border-blue-500"
         style={{backgroundColor: 'rgba(0, 0, 255, 0.1)'}} /* 🔵 BLUE = SalonDashboard */
    >

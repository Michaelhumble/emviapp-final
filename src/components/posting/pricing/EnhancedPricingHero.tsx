...
import { Timer, Star, Users, TrendingUp, Zap } from 'lucide-react';

const EnhancedPricingHero = () => {
    ...
    <div className="text-center space-y-8 mb-16">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-orange-800">12 spots left this week</span>
        </div>
...
export default EnhancedPricingHero;

...
import { Scissors, Brush, Star, Palmtree, Hammer, SunMedium, Dumbbell, Users, Heart, Radiation, CircleDashed } from 'lucide-react';
...
interface IndustryOption {
  ...
  title: string;
  description: string;
  icon: any; // Using any for now as we're using Lucide icons
}

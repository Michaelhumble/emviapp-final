...
const JobTemplates: React.FC<JobTemplateProps> = ({ onTemplateSelect, expressMode = false }) => {
  const populateNailTechTemplate = () => {
    onTemplateSelect({
      ...
      vietnamese_description: "Cần thợ nail có kinh nghiệm tham gia salon của chúng tôi. Phải có ít nhất 2 năm kinh nghiệm với bột, gel, và vẽ móng. Tiềm năng thu nhập tốt với cơ cấu trả lương theo hoa hồng. Môi trường làm việc thân thiện với khách hàng thường xuyên.",
      location: "Boston, MA",
  ...
  const populateHairStylistTemplate = () => {
    onTemplateSelect({
      ...
      vietnamese_description: "Đang tìm một thợ tóc có kỹ năng để tham gia vào salon cao cấp của chúng tôi. Phải thành thạo cắt, nhuộm và tạo kiểu các loại tóc khác nhau. Yêu cầu kỹ năng chăm sóc khách hàng tốt. Thù lao dựa trên hoa hồng với tiềm năng tăng trưởng.",
      location: "Chicago, IL",
  ...
  const populateReceptionistTemplate = () => {
    onTemplateSelect({
      ...
      vietnamese_description: "Đang tuyển một lễ tân thân thiện, có tổ chức cho salon và spa bận rộn của chúng tôi. Nhiệm vụ bao gồm lên lịch hẹn, trả lời điện thoại, chào đón khách hàng và xử lý thanh toán. Phải có kỹ năng chăm sóc khách hàng tốt và chú ý đến chi tiết.",
      location: "Miami, FL",
      jobType: "full-time" as JobType,

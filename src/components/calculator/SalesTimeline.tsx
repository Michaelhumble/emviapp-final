...
export const SalesTimeline: React.FC = () => {
  const timeline = [
    { phase: 'List on EmviApp', duration: '1 day', icon: '📝' },
    { phase: 'Receive inquiries', duration: '1-2 weeks', icon: '📧' },
    { phase: 'Negotiate & due diligence', duration: '2-4 weeks', icon: '🤝' },
    { phase: 'Close the sale', duration: '2-3 weeks', icon: '🎉' },
  ];

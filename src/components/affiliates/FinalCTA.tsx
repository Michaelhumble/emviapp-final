  ...
  return (
    <section className="relative overflow-hidden py-20">
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-5xl text-center">
        ...
        >
          {/* Headline */}
          <h2 className="text-hero-secondary text-white">
          ...
          {/* Subcopy */}
          <p className="text-body-large text-slate-200 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            >
              <Button 
                size="lg"
                className="btn-magnetic focus-ring-premium bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-600 hover:to-blue-600 text-white h-16 px-12 text-xl font-bold min-w-[200px] rounded-2xl shadow-2xl group"
              >
                Join Now
                <motion.div
                  className="ml-2"
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="h-16 px-10 text-lg font-semibold border-2 border-white/30 hover:border-emerald-400 text-white hover:text-emerald-400 rounded-2xl min-w-[180px] bg-white/10 backdrop-blur-sm hover:bg-white/20"
            >
              View Dashboard
            </Button>
          </div>

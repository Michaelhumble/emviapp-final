...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ['Inter', 'Be Vietnam Pro', ...fontFamily.sans],
        inter: ['Inter', 'Be Vietnam Pro', ...fontFamily.sans],
        playfair: ['Playfair Display', 'Be Vietnam Pro', 'serif'],
        serif: ['Playfair Display', 'EB Garamond', 'Be Vietnam Pro', 'serif'],
